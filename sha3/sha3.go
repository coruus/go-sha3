...
func New224() hash.Hash {
	d := &state{rate: 144, outputSize: 28, dsbyte: 0x06}
	return d
}
...
func New256() hash.Hash {
	return &state{rate: 136, outputSize: 32, dsbyte: 0x06}
}
...
func New384() hash.Hash {
	return &state{rate: 104, outputSize: 48, dsbyte: 0x06}
}
...
func New512() hash.Hash {
	return &state{rate: 72, outputSize: 64, dsbyte: 0x06}
}
