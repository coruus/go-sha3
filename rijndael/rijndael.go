// from AGL's Pond package; same license.
package rijndael
...
// See page 42 of the Rijndael book.
var roundTable = [][]uint32{
	// Nw =   4,  5,  6,  7,  8   // Nk =
	[]uint32{10, 11, 12, 13, 14}, // 4
	[]uint32{11, 11, 12, 13, 14}, // 5
	[]uint32{12, 12, 12, 13, 14}, // 6
	[]uint32{13, 13, 13, 13, 14}, // 7
	[]uint32{14, 14, 14, 14, 14}, // 8
}

// linear:       Nk + Nw +  2 ==> Rijndael[Nk=8,Nw=8,Nr=18]
// twofishy:     Nk + Nw + 12 ==> Rijndael[Nk=8,Nw=8,Nr=28]
// (see Twofish Author Comments)
// conservative: 2*Nk + 2*Nw ==> Rijndael[Nk=8,Nw=8,Nr=32]
